            ...
            <div className="flex space-x-1">
                ...
                {paginas.map((pagina, index) => (
                    <Link
                        ...
                        className={`flex items-center justify-center min-w-9 min-h-9 text-sm font-normal text-slate-800 border rounded hover:bg-blue-gray-400 hover:border-slate-600 hover:text-white transition duration-200 ease
                            ${
                                pagina === paginaActual
